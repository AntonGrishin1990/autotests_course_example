...
def scrabble(word):
    """
   Ссумируем количество очков за буквы в слове
   :param word: слово, в котором считаем очки
   :return points: количество набранных очков за буквы в слове
   """
    points = 0
    price = {"а": 1, "в": 1, "е": 1, "ё": 1, "и": 1, "н": 1, "о": 1, "р": 1, "с": 1, "т": 1, "д": 2, "к": 2, "л": 2,
